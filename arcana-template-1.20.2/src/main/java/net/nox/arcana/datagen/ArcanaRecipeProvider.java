...
public class ArcanaRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ArcanaItems.CAST_PROPULSION_SCROLL, 1)
                .input(ArcanaItems.END_SPELL_SCROLL, 1)
                .input(ArcanaItems.CASTER_RUNE, 1)
                .input(Items.PHANTOM_MEMBRANE, 1)
                .criterion(hasItem(ArcanaItems.END_SPELL_SCROLL), conditionsFromItem(ArcanaItems.END_SPELL_SCROLL))
                .criterion(hasItem(ArcanaItems.CASTER_RUNE), conditionsFromItem(ArcanaItems.CASTER_RUNE))
                .criterion(hasItem(Items.PHANTOM_MEMBRANE), conditionsFromItem(Items.PHANTOM_MEMBRANE))
                .offerTo(exporter, "cast_propulsion_scroll");
        ...
        // WHIP
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ArcanaItems.MAGIC_WHIP, 1)
                .pattern("  M")
                .pattern(" C ")
                .pattern("L  ")
                .input('L', Items.LEAD)
                .input('C', Items.CHAIN)
                .input('M', ArcanaItems.MAGIC_WAND_CORE)
                .criterion(hasItem(Items.LEAD), conditionsFromItem(Items.LEAD))
                .criterion(hasItem(Items.CHAIN), conditionsFromItem(Items.CHAIN))
                .criterion(hasItem(ArcanaItems.MAGIC_WAND_CORE), conditionsFromItem(ArcanaItems.MAGIC_WAND_CORE))
                        .offerTo(exporter, "magic_whip");
