...
public class CastMeteorologyScrollItem extends MagicSpellScrollItem {
        ...
        private static final String SPELL = "cast_meteorology";
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.arcana.cast_meteorology_scroll.spell_description").formatted(Formatting.GRAY));
