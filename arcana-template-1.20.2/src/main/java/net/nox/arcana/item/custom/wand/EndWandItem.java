...
public class EndWandItem extends Item {
    ...
    // CONSTRUCTOR
    public EndWandItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        for (MagicSpellScrollItem magicSpellScrollItem : getMagicSpellScrollItems()) {
            if (item.equals(magicSpellScrollItem)) {
                ...
                // Apply 250% reduction for "end" spells
                if (type.equals("end")) {
                    cooldown /= 10;
                    cost /= 10;
                }
        ...
        if (playerEntity.getStackInHand(hand).getItem() == ArcanaItems.END_WAND && playerEntity.totalExperience >= -cost && !cast) {
                    ...
                    switch (spell) {
                        case "build_nether_portal" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                NetherPortalBuilder portalBuilder = new NetherPortalBuilder((ServerWorld) world, pos, direction, false);
                        ...
                        case "build_pillar" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                if (NaturalBlocks.isNatural(hitBlock)) {
                                    PillarBuilder pillarBuilder = new PillarBuilder((ServerWorld) world, pos, direction, hitBlock, 10, ArcanaItems.END_WAND);
                        ...
                        case "build_stairs" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                Block hitBlock = hitBlockState.getBlock();
                                if (NaturalBlocks.isNatural(hitBlock)) {
                                    StairsBuilder stairsBuilder = new StairsBuilder((ServerWorld) world, pos, direction, hitBlock, 10, ArcanaItems.END_WAND, playerEntity.isSneaking());
                        ...
                        case "build_wall" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                Block hitBlock = hitBlockState.getBlock();
                                if (NaturalBlocks.isNatural(hitBlock)) {
                                    WallBuilder wallBuilder = new WallBuilder((ServerWorld) world, pos, direction, hitBlock, 3);
                        ...
                        case "build_platform" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                Block hitBlock = hitBlockState.getBlock();
                                if (NaturalBlocks.isNatural(hitBlock)) {
                                    PlatformBuilder platformBuilder = new PlatformBuilder((ServerWorld) world, pos, hitBlock, 5);
