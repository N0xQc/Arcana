...
public class CastClarityScrollItem extends MagicSpellScrollItem {
    ...
    private static final String SPELL = "cast_clarity";
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.arcana.cast_clarity_scroll.spell_description").formatted(Formatting.GRAY));
