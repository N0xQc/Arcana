                    ...
                    switch (spell) {
                        ...
                        case "build_pillar" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                if (NaturalBlocks.isNatural(hitBlock)) {
                                    PillarBuilder pillarBuilder = new PillarBuilder((ServerWorld) world, pos, direction, hitBlock, 10, ArcanaItems.MAGIC_WAND);
                        ...
                        case "build_stairs" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                Block hitBlock = hitBlockState.getBlock();
                                if (NaturalBlocks.isNatural(hitBlock)) {}
                                StairsBuilder stairsBuilder = new StairsBuilder((ServerWorld) world, pos, direction, hitBlock, 10, ArcanaItems.MAGIC_WAND, playerEntity.isSneaking());
                        ...
                        case "build_wall" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                Block hitBlock = hitBlockState.getBlock();
                                if (NaturalBlocks.isNatural(hitBlock)) {
                                    WallBuilder wallBuilder = new WallBuilder((ServerWorld) world, pos, direction, hitBlock, 5);
                        ...
                        case "build_platform" -> {
                            ...
                            if (blockHitResult.getType() == HitResult.Type.BLOCK) {
                                ...
                                Block hitBlock = hitBlockState.getBlock();
                                if (NaturalBlocks.isNatural(hitBlock)) {
                                    PlatformBuilder platformBuilder = new PlatformBuilder((ServerWorld) world, pos, hitBlock, 10);
